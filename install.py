...
def cli() -> None:
	...
	program.add_argument('--onnxruntime', help = 'help.install_dependency', choices = ONNXRUNTIMES.keys())
	program.add_argument('--skip-venv', help = 'help.skip_venv', action = 'store_true')
	run(program)
...
def run(program : ArgumentParser) -> None:
	...
	if args.onnxruntime:
		...
		[
			inquirer.List('onnxruntime', message = 'help.install_dependency', choices = list(ONNXRUNTIMES.keys()))
		])
	if answers:
