...
def test_main_process():
    ...
    globals.target_path = '/Users/haruki/Sites/dev/ml/Mimix/tests/images/manyface.jpg'
    globals.output_path = '/Users/haruki/Sites/dev/ml/Mimix/tests/images/result.jpg'
    main_process()
